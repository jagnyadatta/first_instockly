...
function CountdownTimer({ startDate, endDate }: { startDate: string | Date; endDate: string | Date }) {
  ...
  const calcTimeLeft = () => {
    ...
    // Calculate remaining time based on the window [start, end]
    let distance: number;
    if (now < start) {
      // Before start: show full duration (end - start)
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen pt-16 sm:pt-0">
          ...
          <div className="lg:w-1/2 mb-6 lg:mb-0 animate-fade-in-left px-2 sm:pl-6">
            ...
            <div className="mb-6 sm:mb-8">
              <CountdownTimer startDate={"2025-09-05T00:00:00"} endDate={"2025-10-05T00:00:00"} />
            </div>
